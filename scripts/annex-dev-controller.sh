#!/usr/bin/env bash
#
# Launch a Clubhouse instance as "controller" (Instance B) with an isolated
# userData directory. Used for manual Annex V2 testing.
#
# Usage: ./scripts/annex-dev-controller.sh
#
set -euo pipefail
...
USER_DATA="${TMPDIR:-/tmp}/clubhouse-annex-controller"
mkdir -p "$USER_DATA"

echo "=== Clubhouse Annex V2 — Controller (Instance B) ==="
