...
function ZoneThemePicker({ currentThemeId, onSelect }: ZoneThemePickerProps) {
  const themeIds = getAllThemeIds();

  return (
    <div
      className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-ctp-mantle border border-surface-1 rounded-lg shadow-xl p-2 z-[10000] min-w-[200px]"
      onMouseDown={(e) => e.stopPropagation()}
    >
